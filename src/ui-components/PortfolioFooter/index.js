    ...
    render = () => {
        return (
            <div style={{backgroundColor: this.props.bgColor}} className='footer-container'>
                <div onClick={() => this.scrollTo()} style={{backgroundColor: this.props.color}} className='footer-navigate'>
                    <i style={{color: this.props.bgColor}} className="fas fa-arrow-alt-circle-up navigate-top"></i>
                </div>
